...
export GST_PLUGIN_PATH=/var/volatile/bsext/ext_npu_argus/RK3588/lib/gstreamer-1.0:/usr/lib/gstreamer-1.0
export LD_LIBRARY_PATH=/var/volatile/bsext/ext_npu_argus/RK3588/lib:/usr/lib:$LD_LIBRARY_PATH
