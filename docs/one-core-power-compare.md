...
|----------|-------------|---------------------|-------|-------|
| **BrightSign XT5** | 58 mA | 73 mA | **+15 mA** | RK3588 NPU with optimized inference |
...
1. **Minimal incremental power**: Face detection adds only 15 mA (26% increase) beyond static baseline
2. **19x more efficient** than RPi5 with Hailo NPU during face detection (73 mA vs. 1383 mA)
3. **10.8x more efficient** than OrangePi 5B+ during face detection (73 mA vs. 787 mA)
4. **Lowest static power**: 58 mA baseline is 4.6x lower than OrangePi and 15.7x lower than RPi5+Hailo

### Implications for Deployment

**24/7 Operation:**
- **XT5**: 73 mA × 24 hours = 1.75 Ah/day
- **OrangePi 5B+**: 787 mA × 24 hours = 18.9 Ah/day (10.8x more)
- **RPi5+Hailo**: 1383 mA × 24 hours = 33.2 Ah/day (19x more)
...
- For 1000-device retail deployment:
  - XT5: 3.2 MWh/year
  - OrangePi: 34.5 MWh/year (+31.3 MWh annual cost)
  - RPi5+Hailo: 60.6 MWh/year (+57.4 MWh annual cost)
...
|----------|----------------------------------|-------|
| **BrightSign XT5** | ~73-95 mA | Efficient power gating, minimal incremental cost per core |
...
- **Minimal incremental power** for single-core face detection (+15 mA)
- **19x lower power consumption** vs. RPi5+Hailo
